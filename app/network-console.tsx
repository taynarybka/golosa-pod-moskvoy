...
export function RolePortrait({index=0,roleId}:{index?:number;roleId?:string}){const portrait=roleId?rolePortraitIndex[roleId]??index:index;return <div className="role-portrait" style={{backgroundImage:"url('./npc-atlas-v1.png')",backgroundPosition:`${(portrait%5)*25}% ${Math.floor(portrait/5)*25}%`}} aria-hidden="true"/>;}
