...
export const stationResources: Record<string, StationResource> = {
  "1::бульвар рокоссовского": {
    ...
    "label": "Патроны",
    "icon": "▮",
    "detail": "Одно действие «остаться» даёт один патрон."
  },
  "1::черкизовская": {
    "kind": "rice",
    "label": "Патроны",
...
export const scenarioStartBriefs: Record<string, { distance: number; history: string; branch: string }> = {
  ...
  "8::новогиреево": {
    ...
    "branch": "Жёлтая ветка знаменита рынками, патронными дворами и короткими дорогами к центру."
  },
  "9::пражская": {
    "distance": 11,
  ...
  "10::окружная": {
    "distance": 10,
    "history": "После катастрофы переходные галереи Окружной стали рынком слухов: здесь первыми узнают, какой кордон поднял цену и где исчез караван.",
    "branch": "Салатовая ветка — линия вентиляции и служебных обходов; краткий путь к Полису проходит через два разных режима контроля."
  },
  "2::водный стадион": {
    "distance": 10,
    "history": "На Водном стадионе бывшие лодочные мастера читают затопления по запаху воздуха и выдают путникам промасленные маршрутные листы.",
    "branch": "Зелёная ветка — речной торговый путь; дорога к центру быстрая, но центральный досмотр особенно внимателен к закрытым ёмкостям."
  },
  "6::калужская": {
    "distance": 11,
    "history": "Калужская хранит архив довоенных инженерных смен. Местные продают не карты, а расписание постов, которое устаревает каждую Ночь.",
    "branch": "Оранжевая ветка — научный коридор с лекарствами и деталями; первый кордон спокоен, второй охраняет дорогу к Полису."
  },
  "7::спартак": {
    "distance": 10,
    "history": "Пустые технические помещения Спартака превратились в убежище беглых торговцев. Здесь учат говорить с патрулём так, чтобы не произнести ни одной прямой лжи.",
    "branch": "Фиолетовая ветка — торговая артерия; её путь короток, но центральный кордон дорог и запоминает подозрительные вещи."
  },
  "8A::мичуринский проспект": {
    "distance": 10,
    "history": "Мичуринский проспект сохранил часть автоматических дверей. Они открываются только после короткого сигнала, который жители считают голосом погибшего диспетчера.",
    "branch": "Солнцевская ветка — технологичная линия; оба обязательных кордона сравнительно дешёвы, зато маршрут чаще требует ремонта."
  }
};
