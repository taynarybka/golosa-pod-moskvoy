...
export function SoloConsole(){
  ...
  useEffect(()=>{if(lostLimbs==null){lostLimbsRef.current=null;return;}if(lostLimbsRef.current!=null&&lostLimbs>lostLimbsRef.current)setDamageFlash(value=>value+1);lostLimbsRef.current=lostLimbs;},[lostLimbs]);
